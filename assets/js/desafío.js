...
resu.innerHTML = `Primer paciente: ${radio[0].Paciente}  - ${
  radio[0].Prevision
} <br>
  Último paciente: ${radio[radio.length - 1].Paciente}  - ${
...
document.getElementById("resultado2").innerHTML = `Primer paciente: ${
  trauma[0].Paciente
}  - ${trauma[0].Prevision} <br>
  Último paciente: ${trauma[trauma.length - 1].Paciente}  - ${
...
document.getElementById("resultado3").innerHTML = `Primer paciente: ${
  dental[0].Paciente
}  - ${dental[0].Prevision} <br>
  Último paciente: ${dental[dental.length - 1].Paciente}  - ${
